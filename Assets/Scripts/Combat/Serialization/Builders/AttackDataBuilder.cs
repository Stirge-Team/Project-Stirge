...
namespace Stirge.Combat.Attacks.Serialization
{
    public class AttackDataBuilder
    {
        ...
        #region BindingAdder
        /// <summary>
        /// Always call this method after calling <see cref="AddAttackNode{TAttackNode}(string)"/> as this binding will be linked to the last added AttackNode.
        /// </summary>
        /// <param name="value"></param>
        public void AddBinding(int value)
        {
            m_attackNodeBindings.Add(value);
        }
        #endregion
