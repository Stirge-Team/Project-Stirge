...
namespace Stirge.Player
{
  ...
  public class EnemyToCamPasser : MonoBehaviour
  {
    ...
    [SerializeField] private float m_GrabEnemiesWaitTime = 1;
    [SerializeField] private float m_ValidateWaitTime = 2;
    ...
    private IEnumerator ValidateEnemies(float waitTime)
    {
      ...
      if(m_enemyAgentList.Count > 0)
      {
        ...
        FindFirstObjectByType<TrackingCamera>().ReplaceSecondaryTargets(validEnemies.ToArray());
      }
